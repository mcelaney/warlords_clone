defmodule Game.Core.Empire do
  @moduledoc """
  The character identity of a player in the game.
  ...
  ## Examples
      ...
      iex> Game.Core.Empire.new(%{
      ...>   id: :storm_giants,
      ...>   label: "Storm Giants"
      ...> })

      %Game.Core.Empire{id: :storm_giants, label: "Storm Giants"}
  """
