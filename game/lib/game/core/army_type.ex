defmodule Game.Core.ArmyType do
  @moduledoc """
  Defines the types of playable armies which can be found or produced by players.

  These are used, in combination with `Game.Core.ArmyTemplate`, to generate
  individual armies.
  """
  use Ecto.Schema
  ...
  ## Examples
      ...
      %Game.Core.ArmyType{id: :archer, label: "Elven Archers",
