defmodule Game.Core.City do
  @moduledoc """
  A city is a location on the map that can be captured by an empire.

  The goal of the game is to capture all cities on the map. Once captured, cities
  ...
  ## Examples
      ...
      iex> giant = ArmyTemplate.new!(%{type: :giant, time: 2, cost: 4, strength: 6, movement: 12})
      ...> Game.Core.City.new(%{
      ...>   id: :stormheim,
      ...>   label: "Stormheim",
      ...>   defense: 6,
      ...
      %Game.Core.City{
        ...
        label: "Stormheim",
        defense: 6,
        army_templates: [%ArmyTemplate{type: :giant, time: 2, cost: 4, strength: 6, movement: 12}],
        capital: :storm_giants
      }
